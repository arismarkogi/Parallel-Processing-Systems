...
#PBS -o /home/parallel/parlab20/a2/kmeans/run/out/run_atomic_kmeans.out
#PBS -e /home/parallel/parlab20/a2/kmeans/run/err/run_amotic_kmeans.err
...
do
        ...
        ./kmeans_omp_naive -s 32 -n 16 -c 32 -l 10 >> "/home/parallel/parlab20/a2/kmeans/run/out/run_atomic_${cores}.out" 2>> "/home/parallel/parlab20/a2/kmeans/run/err/run_atomic_${cores}.err"
    done
